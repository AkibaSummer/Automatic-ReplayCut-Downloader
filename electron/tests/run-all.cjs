...
const tests = [
  ...
  'electron/tests/portable-package-relocation.ts',
  'electron/tests/config-transaction.ts',
  'electron/tests/db-schema-migration.ts',
  'electron/tests/local-origin-policy.ts',
  'electron/tests/avatar-proxy.ts',
  'electron/tests/bilibili-network.ts',
  'electron/tests/stream-cache-compaction.ts',
  'electron/tests/disk-stats-performance.ts',
  ...
  'electron/tests/file-publish-lock.ts',
  'electron/tests/temp-directory-recovery.ts',
  'electron/tests/external-output-reconciliation.ts',
